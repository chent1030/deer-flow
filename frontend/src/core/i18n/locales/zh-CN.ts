...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    shareTitle: "分享智能体",
    shareDescription:
      "分享后会为对方创建独立副本，后续修改互不影响。",
    shareSearchPlaceholder: "搜索用户",
    shareNoUsers: "没有可分享的用户",
    newChat: "新对话",
  ...
  scheduler: {
    title: "定时任务",
    description: "创建和管理周期性执行的智能体任务。",
    createTask: "新建任务",
    noTasks: "还没有定时任务。",
    taskName: "任务名称",
    taskNamePlaceholder: "每周市场动态总结",
    prompt: "提示词",
    promptPlaceholder: "描述该任务运行时智能体需要完成的事情。",
    skill: "技能",
